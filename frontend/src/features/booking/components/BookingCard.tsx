...
//                   </Button>
//                 )}
//                 {(b.status === BOOKING_STATUS.IN_PROGRESS || isExtraCharge)  && b.category.serviceType !== SERVICE_TYPE.CONSULTATION  && (
//                   <Button
//                     variant="warning"
//                     size="sm"
...
//                   </Button>
//                 )}
//                 {( b.category.serviceType  === SERVICE_TYPE.CONSULTATION || b.category.serviceType === SERVICE_TYPE.INSPECTION )&& (
//                   <Button
//                     variant="blue"
//                     size="sm"
//                     iconLeft={<PlayCircle size={12} />}
//                     onClick={() => handlers?.onSendQuote?.(b)}
//                   >
//                     Enter Details and sent quato
//                   </Button>
//                 )}
...
export default function BookingCard({ booking: b, handlers, role, index, detailPath }: Props) {
  ...
  const quotePath = b.quoteId ? `/worker/quote` : `/worker/quote/${b.id}`;
