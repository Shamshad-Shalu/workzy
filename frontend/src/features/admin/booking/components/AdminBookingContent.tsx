...
interface AdminBookingContentProps {
  workerId?: string;
  userId?: string;
  hideHeader?: boolean;
}

export function AdminBookingContent({
  workerId,
  userId,
  hideHeader = false,
}: AdminBookingContentProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={cn('bg-card border rounded-xl p-6 pb-0', !hideHeader && 'mt-12')}>
