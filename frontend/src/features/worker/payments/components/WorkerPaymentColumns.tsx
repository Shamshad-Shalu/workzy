...
const WorkerPaymentColumns = (): TableColumnDef<PaymentWorker>[] => [
  {
    id: 'transactionId',
    header: 'Transaction',
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <span className="text-foreground font-medium hover:text-primary transition-colors text-sm">
...
export default WorkerPaymentColumns;
